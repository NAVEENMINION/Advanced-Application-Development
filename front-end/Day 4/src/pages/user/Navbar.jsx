...
import back2 from '../../assets/images/39-390077_college-graduate-with-diploma.jpg';
import back3 from '../../assets/images/HD-download-college-wallpapers.jpg';
...
const Navbar = () => {
    ...
    <div className='full-navbar'>
      <div className='nav'>
        ...
        <ul className='nav-menu'>
          ...
          <li className='nav-item nav-dropdown'>
            <span className='nav-link'>Tabs</span>
            <div className='navlink-drop'>
              <Link to=" " className='dropdown-link'>Departments</Link>
              <Link to=" " className='dropdown-link'>College Details</Link>
              <Link to=" " className='dropdown-link'>Blog Details</Link> 
              <Link to=" " className='dropdown-link'>Admission Details</Link> 
              <Link to=" " className='dropdown-link'>Registration Form</Link> 
              <Link to=" " className='dropdown-link'>Enrollment Form</Link> 
              <Link to=" " className='dropdown-link'>Payment</Link> 
            </div>
          </li>
          <li className='nav-item'>
      ...
      <div class='box-university'>
        ...
        <h2 class='box-title'>World's Best Colleges is here</h2>
        <p class='box-text'>College admissions generally refer to the process by which students apply and are accepted into colleges and universities for higher education<br/> Ipsum Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br/>Consequuntur, deserunt.</p>
        <p class='box-text'>Students must submit high school transcripts, which provide a record of their academic performance. <br/>They may also need to submit recommendation letters from teachers, counselors, or other mentors who can speak to their character, abilities, and achievements. <br/>Consequuntur, deserunt.</p>
  ...
  <footer className="footer">
      ...
      <div className="footer-bottom">
        <p>Naveen Institution of technology 2024. All Rights Reserved.</p>
      </div>
    </footer>
  </div>
